...
- Z. Li, Y. Shi, H. Ling*, J. Chen, R. Wang, C. Zhao, Q. Wang and <strong>S. Huang</strong>, "Knowledge Consistency Distillation for Weakly Supervised One Step Person Search," in *IEEE Transactions on Circuits and Systems for Video Technology (<strong>IEEE TCSVT</strong>)*, 2024. [[Paper]](https://ieeexplore.ieee.org/document/10599306)

- Z. Li, J. Li, Y. Shi, H. Ling*, J. Chen, R. Wang, and <strong>S. Huang</strong>, "Cross-modal generation and alignment via attribute-guided prompt for unsupervised text-based person retrieval," in *Proceedings of the Thirty-Third International Joint Conference on Artificial Intelligence (<strong>IJCAI '24</strong>)*. [[Paper]](https://doi.org/10.24963/ijcai.2024/116)
